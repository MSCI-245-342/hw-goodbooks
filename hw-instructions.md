...
1. Add a method named `most_liked_book` to the Author model that returns a Book object for the author's book with the highest average rating.  If an author has no books rated, return nil.  
